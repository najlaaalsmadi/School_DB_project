...
namespace School_DB_project.Controllers
{
    public class StudentsController : Controller
    {
        ...
        {
            ViewBag.StudentId = new SelectList(db.StudentDetails, "StudentDetailsId", "Address");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "StudentId,Name")] Student student)
        {
            ...
            ViewBag.StudentId = new SelectList(db.StudentDetails, "StudentDetailsId", "Address", student.StudentId);
            return View(student);
        }
